<?php
/**
 * CA Framework - Offer Template: Starter
 *
 * A clean, gradient banner-style offer template.
 *
...
// dd($offer);
?>
<div class="ca-fw-offer ca-fw-offer-starter" id="ca-fw-offer-<?php echo esc_attr( $offer['id'] ); ?>" data-dismiss-id="<?php echo esc_attr( $offer['id'] ); ?>">
    <div class="ca-fw-offer-inner">
        ...
        <div class="ca-fw-offer-content">
            <?php if ( ! empty( $offer['badge_text'] ) ) : ?>
                <span class="ca-fw-badge"><?php echo esc_html( $offer['badge_text'] ); ?></span>
            <?php endif; ?>
            ...
            <?php if ( ! empty( $offer['highlight_text'] ) ) : ?>
                <div class="ca-fw-offer-highlight"><?php echo wp_kses_post( $offer['highlight_text'] ); ?></div>
            <?php endif; ?>
